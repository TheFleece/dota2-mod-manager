...
export const modAliases: Record<string, string[]> = {
  ...
  'Tower re-aggro Radius': ['радиус тавера', 'радиус агра вышки', 'как включить радиус реагра тавера'],
  'Purple Click': ['цвет клика', 'фиолетовый клик', 'как поменять цвет клика'],
  'Blue Click': ['синий клик', 'цвет клика'],
  'Dummy In Profile': ['мишень в профиле', 'манекен в профиле'],
  'Unlock Hidden Profile Animations': ['скрытые анимации в профиле'],
  'Profile Graffiti & Phrases': ['граффити в профиле', 'фразы в профиле'],
