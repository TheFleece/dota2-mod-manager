...
Написано здесь, потому что догадки хуже. Всё, по чему можно судить о коде, и так открыто: 513
коммитов истории, 423 теста, порог покрытия, который держит CI, и [DECISIONS.md](DECISIONS.md),
где на частые вопросы ревьюеров отвечают командой, которую можно запустить самому.
