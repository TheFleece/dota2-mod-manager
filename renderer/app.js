...
// still owes the shell: a dropped mod can land on any screen, and the catalog is fetched at
// boot and re-fetched from Settings, both of them outside the screen that shows it.
